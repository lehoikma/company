        ...
        <div class="container">
            <div class="navigate">
                <ol>
                    ...
                    <li>
                        <a href="" target="_self" style="color: black"><span>{{ trans('messages.tuyen_dung') }}<span></span></span></a>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="container">
            <div class="box-title">
                <h1 style="margin-top: 0px;">
                    <a class="text" href="" target="_self" style="color: #009244; font-weight: 600; font-family: 'Roboto Condensed',sans-serif;">{{ trans('messages.tuyen_dung') }}</a></h1>
            </div>
                    ...
                    @foreach($categoryImage as $category)
                        ...
                        <div class="item-box">
                            <figure style="width: 100%; height: 213.514px;">
                                <a href="{{route('user_detail_tuyen_dung', ['title' => str_slug($category['name']), 'id' => $category['id']])}}">
