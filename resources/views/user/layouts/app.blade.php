                        ...
                        <div class="widget widget__social">
                            <a href="https://www.facebook.com/thuocthuyamavet/" rel="nofollow" class="builtin-icons facebook-hover" target="_blank" alt="Follow Us on facebook" title="Follow Us on facebook">
                                <svg class="icon" aria-hidden="true" style="height: 2em;width: 2em;fill: #ebebeb;">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#viphavet-fb">
                                        <svg id="viphavet-fb" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M192.191 92.743v60.485h-63.638v96.181h63.637v256.135h97.069v-256.135h84.168s6.674-51.322 9.885-96.508h-93.666v-42.921c0-8.807 11.565-20.661 23.01-20.661h71.791v-95.719h-83.57c-111.317 0-108.686 86.262-108.686 99.142z"></path></svg>
                                    </use>
                                </svg>
                            </a>
