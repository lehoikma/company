                                            ...
                                            <tr role="row">
                                                ...
                                                <td>
                                                    @if(strtotime($nowDate) < strtotime($startDate))
                                                        <span class="label label-primary">Chưa đấu giá</span>
                                                        @elseif(strtotime($nowDate) > strtotime($startDate) && strtotime($nowDate) < strtotime($endDate))
                                                        <span class="label label-info">Đang đấu giá</span>
                                                        @else
                                                        <span class="label label-success">Đã đấu giá xong</span>
                                                    @endif
                                                </td>
                                                <td>
